        ...
        <div className="reg-left">
          ...
          <div className="reg-card">
            ...
            <div className="anim-up-2" style={{ marginBottom: 32 }}>
              ...
              >
                Join thousands of property managers generating professional,
                court-ready leases in minutes.
              </p>
            </div>
            ...
            >
              ...
              <div className="field-wrap anim-up-5">
                <label
                  ...
                  className={`field-label ${focused === "confirm" ? "active" : ""}`}
                >
                  Confirm Password
                </label>
                <div className="pw-wrap">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setPasswordMatch(
                        e.target.value === pw || e.target.value === "",
                      );
                    }}
                  />
                  <button
              ...
              <div className="social-grid anim-up-8">
                ...
                >
                  ...
                  >
                    <path
                      d="M11.4 24H0V12.6L11.4 24Z"
                      fill="#F25022"
                      stroke="none"
                    />
                    <path
                      d="M24 24H12.6V12.6L24 24Z"
                      fill="#00A4EF"
                      stroke="none"
                    />
                    <path
                      d="M11.4 11.4H0V0L11.4 11.4Z"
                      fill="#FFB900"
                      stroke="none"
                    />
                    <path
                      d="M24 11.4H12.6V0L24 11.4Z"
                      fill="#7FBA00"
                      stroke="none"
                    />
                  </svg>
        ...
        <div className="reg-right">
          ...
          <div>
            ...
            <div className="anim-2" style={{ marginBottom: 40 }}>
              <div className="right-headline" style={{ color: "var(--paper)" }}>
                READY IN
              </div>
              <div
                className="right-headline"
                style={{ color: "var(--accent)" }}
              >
                5 MINUTES,
              </div>
              <div className="right-serif" style={{ color: "var(--paper)" }}>
                legally sound.
              </div>
            </div>
            ...
            <div className="testimonial-card anim-4" style={{ marginTop: 40 }}>
              ...
              >
                This platform transformed how we manage our properties. Legally
                compliant and incredibly fast to use.
              </p>
              <div
                style={{
                  display: "flex",
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  borderRight:
                    i < 2 ? "1px solid rgba(245,240,232,.08)" : "none",
                }}
              >
                <span
                  className="right-stat-num"
