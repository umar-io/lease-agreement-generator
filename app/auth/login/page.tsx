        ...
        <div className="login-left">
          ...
          <div>
            <div className="anim-2" style={{ marginBottom: 32 }}>
              <div className="left-headline" style={{ color: "var(--paper)" }}>
                FROM
              </div>
              <div className="left-headline" style={{ color: "var(--accent)" }}>
                BLANK PAGE
              </div>
              <div className="left-serif" style={{ color: "var(--paper)" }}>
                to signed.
              </div>
            </div>
            ...
            >
              Generate a complete, legally-binding lease in under 5 minutes.
              Smart templates. Built-in e-signature.
            </p>
            ...
            {[
              ...
              >
                <span
                  ...
                  style={{ color: i === 0 ? "var(--accent)" : "var(--paper)" }}
                >
                  {n}
                </span>
                  ...
                  <div className="login-card">
                    ...
                    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                      ...
                      <div className="anim-up-6">
                        <button type="button" disabled={loading} className="google-btn">
